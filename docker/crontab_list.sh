...
#京喜财富岛
#5 7,12,18 1-22 6 * node /scripts/jd_cfd.js >> /scripts/logs/jd_cfd.log 2>&1
...
#京喜工厂开团
0 0,30 0,1 * * node /scripts/jd_dreamFactory_tuan.js >> /scripts/logs/jd_dreamFactory_tuan.log 2>&1
# 京东试用
